    ...
    <body>
        ...
        <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-5">
                            <div class="thumbnail">
                                <img src="images/g9.jpg" style="max-width: 100%" >
                            ...
                            <a href="cart-add.php?id=5" name="add" value="add" class="btn btn-block btn-success">Enroll Me</a>                                     
                                <?php                                 
                        ...
                        <div  class="col-xs-6">
                            <center><h1><u> Fluid Mechanics</u></h1></center>
        ...
        <div class="row">
                        ...
                        <div  class="col-xs-6">
                            <center><h1><u> Machine Learning </u></h1></center>
                            <h3>Blaaab Blaab Blaab Blaaaaaaaaaaaaaaaaab Blaaaaaaaaaaab Blaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaap</h3>
                        </div>
                    </div>
        </div>
